...
SMB 2.2.0 是 Sutady 的私人账本。它在 Windows 笔记本上运行，通过浏览器同时支持 Windows、Linux 和 Android；账本唯一数据源是本机 SQLite，浏览器不保存账目副本。
...
已明确延后的账户余额、账单导入和历史追踪等方向见 [ROADMAP.md](ROADMAP.md)。
